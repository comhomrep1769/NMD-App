      ...
      <div className="nmd-footer-inner">
        <div className="nmd-footer-top">
          ...
          <div>
            ...
            <p className="nmd-footer-brand-desc">
              Professional pressure washing services in Brevard County &amp;
              Orange County, Florida. Residential, commercial, industrial,
        ...
        <div className="nmd-footer-bottom">
          <p className="nmd-footer-copy">
            © {year} NMD Pressure Washing. All rights reserved. Serving Brevard &amp;
            Orange County, FL.
          </p>
