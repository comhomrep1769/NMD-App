...
export default function SetPasswordPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#f4f7fb', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'DM Sans, sans-serif', padding: '2rem' }}>
      <Suspense fallback={
        <div style={{ background: 'white', borderRadius: 16, border: '1px solid #dde4ef', padding: '2.5rem', maxWidth: 440, width: '100%', textAlign: 'center', boxShadow: '0 8px 40px rgba(14,17,23,0.07)' }}>
          <p style={{ color: '#5a6a88', fontSize: '0.9rem' }}>Loading...</p>
        </div>
      }>
        <SetPasswordForm />
      </Suspense>
