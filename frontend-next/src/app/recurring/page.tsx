  ...
  return (
    <PortalShell requiredRole={["admin", "superadmin", "employee"]}>
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        <h1 style={{ fontFamily: 'Syne, sans-serif', fontSize: '1.75rem', fontWeight: 800, color: '#0e1117', letterSpacing: '-0.03em', marginBottom: 6 }}>Recurring Services</h1>
        <p style={{ color: '#5a6a88', fontSize: '0.875rem' }}>Manage recurring service plans and billing cycles.</p>
      </div>
