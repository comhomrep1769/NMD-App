...
export const metadata: Metadata = {
  title: 'Privacy Policy | NMD Pressure Washing',
  description: 'Privacy policy for NMD Pressure Washing Services LLC.',
}

const DEFAULT = 'Privacy Policy content coming soon.'
...
async function getContent(): Promise<string> {
  try {
    ...
    return data.content?.['page.privacy_policy'] || DEFAULT
