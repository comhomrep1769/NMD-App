...
export default function PortalShell({
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f4f7fb', fontFamily: 'DM Sans, sans-serif', display: 'flex' }}>
      {/* Sidebar */}
      <div style={{ width: 240, minHeight: '100vh', background: '#0e1117', display: 'flex', flexDirection: 'column', position: 'fixed', top: 0, left: sidebarOpen ? 0 : undefined, zIndex: 40, flexShrink: 0 }}>
