      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-[65px]">
        <div className="grid-footer grid grid-cols-[2fr_1fr_1fr_1fr] gap-12 border-b border-white/10 pb-12">
          <div>
            ...
            <p className="mb-5 max-w-[300px] text-sm leading-relaxed !text-white/70">
              Professional pressure washing for homes, businesses, and industrial properties
              across Brevard County, Florida and the Wilkes-Barre area of Pennsylvania.
            </p>
          ...
          <div>
            <div className="mb-5 text-[11px] font-semibold uppercase tracking-[0.14em] !text-white/45">Services</div>
            <div className="flex flex-col gap-2.5">
              {SERVICES_LINKS.map((label) => (
                <a key={label} href="#services" className="text-sm !text-white/85">{label}</a>
              ))}
            </div>
          </div>

          <div>
            <div className="mb-5 text-[11px] font-semibold uppercase tracking-[0.14em] !text-white/45">Service Areas</div>
            <div className="flex flex-col gap-2.5">
              {AREA_LINKS.map((label) => (
                <a key={label} href="#service-areas" className="text-sm !text-white/85">{label}</a>
              ))}
            </div>
          </div>

          <div>
            <div className="mb-5 text-[11px] font-semibold uppercase tracking-[0.14em] !text-white/45">Company</div>
            <div className="flex flex-col gap-2.5">
              <a href="/client/request-service" className="text-sm !text-white/85">Get a Free Quote</a>
              <a href="/client/register" className="text-sm !text-white/85">Create Client Account</a>
              <a href="/mission" className="text-sm !text-white/85">Our Mission</a>
              <a href="/join-our-team" className="text-sm !text-white/85">Join Our Team</a>
              <div className="my-1.5 h-px bg-white/10" />
              <a href="/employee/login" className="flex items-center gap-1.5 text-sm !text-white/60">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 py-5">
          <span className="text-xs !text-white/60">&copy; {copyrightYear} NMD Pressure Washing Services LLC. All rights reserved.</span>
          <div className="flex gap-5">
            <a href="/privacy-policy" className="text-xs !text-white/60">Privacy Policy</a>
            <a href="/terms-of-service" className="text-xs !text-white/60">Terms of Service</a>
            <a href="/sitemap.xml" className="text-xs !text-white/60">Sitemap</a>
          </div>
        </div>
      </div>
    </footer>
