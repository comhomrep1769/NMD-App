      ...
      ? `
        <div style="margin:24px 0;text-align:center;">
          <a href="${escapeHtml(buttonUrl)}"
             style="display:inline-block;background:linear-gradient(135deg,#1f6132,#124d83);color:#ffffff;text-decoration:none;font-weight:800;padding:14px 24px;border-radius:12px;font-size:15px;">
          ...
          <tr>
            <td align="center">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border:1px solid rgba(37,99,235,.18);border-radius:18px;overflow:hidden;box-shadow:0 20px 48px rgba(15,89,150,.14);">
                ...
                <tr>
                  <td style="padding:28px 24px 20px;background:linear-gradient(135deg,#1f6132,#124d83);text-align:center;">
                    <img src="https://nmdpowash.com/nmd-logo-email.png" alt="NMD Pressure Washing Services" style="height:80px;width:auto;display:block;margin:0 auto 12px;" />
