 ...
 */
export async function sendEmployeeOnWaySms(
  clientPhone: string,
  clientName: string,
  employeeName: string,
  eta?: string
  ...
  const message =
    `Hi ${clientName}, your NMD Pressure Washing technician ` +
 ...
 */
export async function sendEmployeeArrivedSms(
  clientPhone: string,
  clientName: string,
  employeeName: string
): Promise<SmsResult> {
  const message =
    `Hi ${clientName}, your NMD technician ${employeeName} has arrived ` +
...
export async function sendJobCompleteSms(
  ...
  const message =
    `Hi ${clientName}, ${service} has been completed by NMD Pressure Washing Services. ` +
