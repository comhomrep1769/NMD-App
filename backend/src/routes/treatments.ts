...
async function seedDefaultTreatments() {
  ...
  const defaultTreatments = [
    ...
    },
    {
      ...
      safetyNotes:
        "Avoid damaging new concrete, verify surface cleaner pace, prevent stripes, watch drainage/runoff, and test questionable surfaces.",
      instructions:
    ...
    },
    {
      ...
      useCase:
        "Exterior cleaning where chalking, fading, oxidation, or weak paint may be present.",
      safetyNotes:
        "Document pre-existing oxidation, perform test spot, explain that washing may reveal uneven oxidation, and avoid aggressive pressure.",
      instructions:
        "Inspect surface, document chalking, test hidden area, use low pressure, avoid scrubbing oxidized panels unless approved, rinse carefully.",
      purchaseLink: "",
      costReference:
        "May require waiver or specialty oxidation restoration pricing if customer expects correction beyond cleaning."
    },
    {
      ...
      useCase:
        "Cleaning organic growth, gray wood, tannin stains, and preparing wood for sealing or staining.",
      safetyNotes:
        "Avoid high pressure, test first, protect plants, explain fuzzing/color variation, and use brightener only when appropriate.",
      instructions:
        "Pre-wet, apply wood-safe cleaner, dwell, gently rinse with low pressure, brighten if needed, and allow proper dry time before sealing.",
      purchaseLink: "",
      costReference:
        "Price higher than basic washing. Account for prep, chemical cost, dwell time, brightening, and restoration risk."
    }
  ];
  ...
  const defaultCases = [
    {
      ...
      recommendedMix:
        "F9 BARC or compatible rust remover per label. Oxalic acid may be used only where appropriate.",
    ...
    },
    {
      ...
      stepByStep:
        "1. Inspect roof pitch/access. 2. Protect plants and runoff areas. 3. Apply roof mix evenly. 4. Let dwell. 5. Reapply stubborn areas. 6. Rinse only if appropriate for scope/material. 7. Final plant rinse.",
      safetyChecklist:
        "Fall protection, ladder safety, runoff control, overspray control, plant protection, and no high pressure.",
      pricingNote:
        "Price by roof size, pitch, access, moss load, chemical cost, and plant protection requirements.",
      customerExpectation:
